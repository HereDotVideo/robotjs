...
BMP buildBMP(Local<Object> info)
{
	...
	img.width = obj->Get(Nan::GetCurrentContext(), Nan::New("width").ToLocalChecked()).ToLocalChecked()->Int32Value(Nan::GetCurrentContext()).ToChecked();
	img.height = obj->Get(Nan::GetCurrentContext(), Nan::New("height").ToLocalChecked()).ToLocalChecked()->Int32Value(Nan::GetCurrentContext()).ToChecked();
	img.byteWidth = obj->Get(Nan::GetCurrentContext(), Nan::New("byteWidth").ToLocalChecked()).ToLocalChecked()->Int32Value(Nan::GetCurrentContext()).ToChecked();
	img.bitsPerPixel = obj->Get(Nan::GetCurrentContext(), Nan::New("bitsPerPixel").ToLocalChecked()).ToLocalChecked()->Int32Value(Nan::GetCurrentContext()).ToChecked();
	img.bytesPerPixel = obj->Get(Nan::GetCurrentContext(), Nan::New("bytesPerPixel").ToLocalChecked()).ToLocalChecked()->Int32Value(Nan::GetCurrentContext()).ToChecked();
